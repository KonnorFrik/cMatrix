...
#define NAME "\033[38;5;45m SUB \033[0m"
...
START_TEST(test_3_invalid) {
  ...
  status = cmatrix_sub(NULL, &v2, &res);
...
START_TEST(test_4_invalid) {
  ...
  status = cmatrix_sub(&v1, NULL, &res);
  ck_assert_int_eq(status, ERROR);
